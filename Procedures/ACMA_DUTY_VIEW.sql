...
BEGIN
  SELECT ACMA_DUTY_RESULT_OBJ( D.DUTY_ID, D.DOCTOR_ID, D.CONSULTING_DATE, D.CONSULTING_TIME_BEGIN, D.CONSULTING_TIME_END,D.TICKETS_PER_DAY ,D.REMAINING_TICKET )
...
FROM ACMA_DUTY D
WHERE D.DOCTOR_ID = 6 AND D.LOCK_STATUS =0
